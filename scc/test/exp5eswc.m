function exp5eswc(infolder,outfolder,pattern)
...
for d = 1:length(dirListing)
    if ~dirListing(d).isdir
        ...
        colLabels = {'\% D/PM','\% PM/M','\% D/M','\% 1-1M','M','\% VtxSCC/Vtx',...
            'probSCC','ASP (s)','\% OptDiag'};
    	...
    	matrix2latexSingle(rawstats, strcat(outfolder, outFile), ...
