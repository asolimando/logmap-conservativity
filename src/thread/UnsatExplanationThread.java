...
import reasoning.OWLLinkSatisfiabilityEntailmentCheckerFactory;
...
public class UnsatExplanationThread extends AbstractExplanationThread {
	...
	public UnsatExplanationThread(OWLOntology alignOnto, OWLClass c, 
			OWLReasonerFactory reasonerFactory, int limit, 
			boolean suppressOutput, long timeout){
		
		this(alignOnto, c, reasonerFactory, limit, suppressOutput, timeout, 10);
	...
	public UnsatExplanationThread(OWLOntology alignOnto, OWLClass c, 
			OWLReasonerFactory reasonerFactory, int limit, 
			boolean suppressOutput, long timeout, int printEach){
