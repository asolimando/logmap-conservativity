...
public class MatcherViolationsAnalyserTest extends AbstractMatcherTest2013 {
	...
	public MatcherViolationsAnalyserTest(String [] args){
		super(args, 0);
	}
...
//		Params.alignOntoClassificationTimeout = 1200;
//		Params.inputOntoClassificationTimeout = 1200;
	}
...
//				null, mappingFile, fstO, sndO, originalMappings);
		...
		try {
			alignOnto = OntoUtil.getAlignedOntology(manager, consistentAlignment, 
					fstO, sndO);
	...
	public static void main(String[] args) 
		...
		new MatcherViolationsAnalyserTest(args).trackTest();
	}
}