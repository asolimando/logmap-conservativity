...
import scc.junit.LargebioTests;
import util.FileUtil;
import util.Params;

public abstract class AbstractMatcherTest2013 extends CombinedMatcher12Test {

	public AbstractMatcherTest2013(String [] args, int testNumber) {		
	...
	protected void trackTest() throws OWLOntologyCreationException, IOException {
		...
		String mappingDir = Params.dataFolder + "oaei2013/" + Params.trackName + "/";
...
//					AML_big_fma2nci
					...
					fstOnto = elem.getParentFile().getParentFile() 
							+ "/onto/" + Params.largebioOntologies13.get(
