...
public abstract class AbstractMatcherTest2014 extends CombinedMatcher12Test {

	public AbstractMatcherTest2014(String [] args, int testNumber) {		
	...
	protected void trackTest() throws OWLOntologyCreationException, IOException {
		...
		String mappingDir = Params.dataFolder + "oaei2014/" + Params.trackName + "/";
