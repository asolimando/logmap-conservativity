...
public class AnchorsAssessmentFullReasoning {
	 ...
	 * @throws Exception
	 */
	public Set<OWLAxiom> classifyAndRepairUnsatisfiability() throws Exception{
		...
		Set<OWLAxiom> bestGlobalPlan = new HashSet<>();
		...
		while (reasoner_access.hasUnsatisfiableClasses()){
			...
			bestGlobalPlan.addAll(applyBestRepairPlan());
	 ...
	 * @return
	 */
	private Set<OWLAxiom> applyBestRepairPlan(){
