...
public class SatisfiabilityIntegration {
	...
	public SatisfiabilityIntegration(
		...
		//Setting up reasoner
				...
				reasonerAccess = createMergedReasonerAccess(ReasonerManager.HERMIT, o1_ax, o2_ax, mappings_ax, useFactory);
	...
	public SatisfiabilityIntegration(
		...
		//Setting up reasoner
				reasonerAccess = createMergedReasonerAccess(ReasonerManager.HERMIT, moduleonto1, moduleonto2, mappingsOntology, useFactory);
	...
	public SatisfiabilityIntegration(boolean timeOutClassification) throws Exception{
		...
		//Setting up reasoner
		reasonerAccess = createMergedReasonerAccess(ReasonerManager.ELK, moduleonto1, moduleonto2, mappingsOntology, true);
