...
public class EvaluateInstanceMatching2012 {
	...
	int test = EvaluateInstanceMatching2012.SANDBOX;
	...
	public EvaluateInstanceMatching2012(){
	...
	private void initStructures(){
		...
		if (test==EvaluateInstanceMatching2012.SANDBOX){
			max_folder=11;
		...
		else if (test==EvaluateInstanceMatching2012.IIMB){
			max_folder=80;
		...
		else if (test==EvaluateInstanceMatching2012.IIMB_LARGE){
			max_folder=80;
	...
	public static void main(String[] args) {
		try{
			new EvaluateInstanceMatching2012();
		}
		catch (Exception e){
			e.printStackTrace();
		}
