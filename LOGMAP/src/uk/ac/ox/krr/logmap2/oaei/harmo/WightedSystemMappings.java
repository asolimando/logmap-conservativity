...
/**
 * Class to manage mappings from a system with a weighted confidence according to its precision. 
 * @author root
 *
 */
public class WightedSystemMappings {
	
	Map<String, Map<String, Double>> mappings2weight = new HashMap<String, Map<String, Double>>();
	

	public WightedSystemMappings(){
		...
		try {
			...
			while ((line = reader.readLine()) != null){
				...
				if (line.contains("|")){
					...
					addMapping(elements[0], elements[1], 1.0); //we add 1.0 vote
